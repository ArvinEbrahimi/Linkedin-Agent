...
@router.put("/profile/{user_id}", response_model=MemoryProfileResponse)
...
@router.get("/posts/{user_id}", response_model=MemoryPostsResponse)
...
@router.post("/posts/{user_id}", response_model=MemoryPostsResponse)
async def add_post(
    user_id: str,
